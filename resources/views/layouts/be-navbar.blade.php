                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div style="height: 100px; display: flex; justify-content: center; align-items: center;">
                        <a href="dashboard" style="display: flex; align-items: center; justify-content: center;">
                            <b class="logo-icon" style="margin: ;">
                                <img src="/backend/assets/images/logo.png" alt="homepage" style="height: 100px;" />
                            </b>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <img src="backend/assets/images/users/profile-pic.jpg" alt="user" class="rounded-circle"
                                    width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                @csrf
                                    <button type="submit" class="dropdown-item d-flex align-items-center">
                                      <i data-feather="power" class="svg-icon mr-2"></i> Logout
                                    </button>
                                </form>
                            </div>
                        </li>

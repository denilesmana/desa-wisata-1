...
<!-- ============================================================== -->
        ...
        <div class="container-fluid mt-5 pt-5" style="padding-left: 250px; padding-right: 20px;"> 
            <h2 class="text-center mb-4">Berita Staydesa</h2>
            <div class="d-flex justify-content-end mb-3">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Tambah Berita</button>
            </div>
        ...
        {{-- <div class="container-fluid mt-5 pt-5" style="padding-left: 250px; padding-right: 20px;"> 
            <h2 class="text-center mb-4">backendrita Staydesa</h2>
                ...
                <table class="table table-bordered align-middle text-center" id="wisataTable" style="min-width: 1000px;">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th style="min-width: 150px;">backendrita</th>
                            <th style="min-width: 100px;">Tanggal Post</th>

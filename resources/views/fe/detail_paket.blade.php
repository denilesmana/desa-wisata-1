                            ...
                            @auth
                                @if(isset($reservasi) && $reservasi)
                                    @if($reservasi->status_reservasi_wisata == 'pesan')
                                        ...
                                        <a href="#" class="btn btn-danger text-white px-4 py-2" data-bs-toggle="modal" data-bs-target="#batalModal">
                                            Batalkan Reservasi
                                        </a>
                                    @elseif(in_array($reservasi->status_reservasi_wisata, ['dibayar', 'selesai']))
                                        <a href="{{ route('reservasi.struk', $reservasi->id) }}" class="btn btn-primary text-white px-4 py-2">
                                            <i class="ti-printer me-2"></i>Cetak Struk
                                        </a>
                                    @elseif($reservasi->status_reservasi_wisata == 'dibatalkan')
                                        {{-- Tidak tampilkan tombol cetak struk jika dibatalkan --}}
                    ...
                    @if(isset($reservasi) && $reservasi)
                        ...
                        <div class="modal fade" id="batalModal" tabindex="-1" aria-labelledby="batalModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <form action="{{ route('reservasi.batal', $reservasi->id) }}" method="POST">
                                        @csrf
                                        @method('PUT') <!-- atau POST jika rutenya menerima POST -->

                                        <div class="modal-header">
                                            <h5 class="modal-title" id="batalModalLabel">Konfirmasi Pembatalan</h5>
                                            <button type="button" class="bi bi-x-lg" data-bs-dismiss="modal" aria-label="Tutup"></button>
                                        </div>
                                        <div class="modal-body">
